    ...
    <div class="min-h-full">
        ...
        <div class="lg:pl-64 flex flex-col">
            ...
            <main class="flex-1">
                    ...
                    <div class="rounded-md bg-blue-50 p-3">
                        <div class="flex">
                            ...
                            <div class="ml-3 flex-1 md:flex md:justify-between">
                                <p class="text-sm text-blue-700">Searching here will only resolve with public resources of other users.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-9 py-4">
                    <form action="{{route('resources.search.results')}}">
                        ...
                        <div class="relative mt-1 flex items-center">
                            ...
                            <div class="absolute inset-y-0 right-0 flex py-1.5 pr-1.5">
                                <kbd class="inline-flex items-center rounded border border-gray-200 px-2 font-sans text-sm font-medium text-gray-400">Enter</kbd>
                            </div>
                        </div>
                    </form>
                </div>
