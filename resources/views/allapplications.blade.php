            ...
            <div class="px-4 sm:px-6 lg:px-8 pt-4">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-xl font-semibold text-gray-900">Applications for "{{$placement->role}}" with {{$placement->company}}</h1>
                    </div>
                </div>
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    @foreach($applicants as $a)
                                        <tr>
                                            <td class="py-4 pl-4 pr-1 text-sm sm:pl-6">
                                                <div class="flex items-center">
                                                    <div>
                                                        <div class="font-medium text-gray-900">{{$a->User->name}}</div>
                                                        <div class="text-gray-500">{{$a->user->email}}</div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                <div class="text-gray-900">{{$a->User->Institution->institution}}</div>
                                                <div class="text-gray-500">{{$a->User->Institution->domain}}</div>
                                            </td>
                                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
