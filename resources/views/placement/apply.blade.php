                    ...
                    <div class="flow-root lg:col-span-8">
                        <form class="space-y-8 divide-y divide-gray-200" method="post" action="{{route('placement.submit', $slug)}}">
                            ...
                            <div class="space-y-8 divide-y divide-gray-200">
                                <div>
                                    <div>
                                        <h3 class="text-lg font-medium leading-6 text-gray-900">Application Form</h3>
                                    ...
                                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                        ...
                                        <div class="sm:col-span-6">
                                            ...
                                            <div class="mt-1">
                                                <textarea id="cv" name="cv" rows="10" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                                            </div>
