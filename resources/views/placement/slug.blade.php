                                ...
                                <div class="border-t border-gray-200 px-4 py-5 sm:p-0">
                                    <dl class="sm:divide-y sm:divide-gray-200">
                                        ...
                                        <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                                            ...
                                            <dd class="mt-1 text-sm text-gray-900 sm:col-span-2 sm:mt-0">{{$placement->description}}</dd>
                                        </div>
                                        <div class="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                                ...
                                @case(false)
                                    <div class="md:flex md:items-center md:justify-between md:space-x-5 pt-5">
                                        ...
                                        <div class="justify-stretch mt-6 flex flex-col-reverse space-y-4 space-y-reverse sm:flex-row-reverse sm:justify-end sm:space-y-0 sm:space-x-3 sm:space-x-reverse md:mt-0 md:flex-row md:space-x-3">
                                            ...
                                            <form action="{{route('placement.apply', $placement->slug)}}" method="get">
                                                <button type="submit" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100">Apply here</button>
                                            </form>
                                        </div>
                                    </div>
                                @break(false)
