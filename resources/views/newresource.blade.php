    ...
    <div class="min-h-full">
        ...
        <div class="lg:pl-64 flex flex-col">
            ...
            <main class="flex-1">
                        ...
                        <div class="mt-4 sm:mt-0 sm:ml-10">
                            <nav class="-mb-px flex space-x-8">
                                ...
                                <a href="{{route('resources')}}"
                                   class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">Mine</a>

                                <a href="{{route('resources.search')}}"
                                   class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">Search</a>

                                <a href="{{route('resources.starred')}}"
                                   class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap pb-4 px-1 border-b-2 font-medium text-sm">Starred</a>
                ...
                <div class="px-9 py-5">
                    <form action="{{route('resources.upload')}}" method="POST">
                        @csrf
                        <div>
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                <div class="md:col-span-1">
                                    <div class="px-4 sm:px-0">
                                        <h3 class="text-lg font-medium leading-6 text-gray-900">Upload here</h3>
                        ...
                        <div class="mt-10 sm:mt-0">
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                <div class="md:col-span-1">
                                    <div class="px-4 sm:px-0">
                                        <h3 class="text-lg font-medium leading-6 text-gray-900">Resource
                                            information</h3>
