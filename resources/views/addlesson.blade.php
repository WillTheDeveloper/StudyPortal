                            ...
                            <main class="max-w-lg mx-auto pt-10 pb-12 px-4 lg:pb-16">
                                <form>
                                    <div class="space-y-6">
                                        ...
                                        <div>
                                            <label for="description" class="block text-sm font-medium text-gray-700"> Start Time </label>
                                            <div class="mt-1">
                                                <div>
                                        ...
                                        <div>
                                            <label for="description" class="block text-sm font-medium text-gray-700"> End time </label>
                                            <div class="mt-1">
                                                <div>
