            ...
            <div class="px-4 sm:px-6 lg:px-8 mt-5">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-xl font-semibold text-gray-900">Group endpoints</h1>
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            <div class="flex items-center">
                                                <div>
                                                    <div class="font-medium text-gray-900">List of groups</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="text-gray-900">{{route('api.groups', '', false)}}</div>
{{--                                            <div class="text-gray-500">Requires valid <b>slug</b> parameter</div>--}}
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            <div class="flex items-center">
                                                <div>
                                                    <div class="font-medium text-gray-900">Get a group by its name</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            <div class="text-gray-900">{{route('api.group.name', 'name', false)}}</div>
                                    ...
                                    <tr>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                            <div class="flex items-center">
                                                <div>
                                                    <div class="font-medium text-gray-900">Get list of users that are in a group</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
